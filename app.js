const PROMPTS = {
  ...
  tweetPrompt: "You are a social media manager. Your task is to write a tweet for a YouTube video based on the transcript for that video. The tweet should be no longer than 200 characters and should be concise. Use portmantues, puns, and wordplay to get the user to click on the video. Give 5 tweet suggestions.",
  tweetThreadPrompt: "Your task is to write a tweet thread for a new release of vs code based on the release notes which will be given to you as a transcript. Create one tweet for each major item in the release. Use portmantues, puns, and wordplay to make each tweet entertaining. End the thread with a tweet that asks a question.",
}
