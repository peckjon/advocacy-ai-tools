const PROMPTS = {
  ...
  titlePrompt: "You are a social media manager. Your task is to write a title for a YouTube video based on the transcript for that video. The title should be no longer than 60 characters and should be concise and something that would cause the user to click on the video. Use suspense, humor, and intrigue to get the user to click on the video.",
